...
std::vector<std::pair<double, MyDataClass*> > MyWriteoutBuffer::Modify(std::pair<double, MyDataClass*> oldData, std::pair<double, MyDataClass*> newData)
{
...
void MyWriteoutBuffer::AddNewDataToTClonesArray(FairTimeStamp* data)
{
  ...
  if (fVerbose > 1) { std::cout << "Data Inserted: "  <<  *(MyDataClass*)(data) << std::endl; }
